using ScheduleUFU_prob2.Common;
using ScheduleUFU_prob2.Data;
using System;
...
namespace ScheduleUFU_prob2
{
    ...
    public sealed partial class GroupedItemsPage : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            await SampleDataSource.AddGroupForFeedAsync("http://blogs.msdn.com/b/mikcher/rss.aspx");
