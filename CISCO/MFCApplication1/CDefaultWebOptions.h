...
// CDefaultWebOptions класс-оболочка

class CDefaultWebOptions : public COleDispatchDriver
{
public:
	CDefaultWebOptions(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
