...
// CXMLSchemaReference класс-оболочка

class CXMLSchemaReference : public COleDispatchDriver
{
public:
	CXMLSchemaReference(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
