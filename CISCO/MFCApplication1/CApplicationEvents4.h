...
// CApplicationEvents4 класс-оболочка

class CApplicationEvents4 : public COleDispatchDriver
{
public:
	CApplicationEvents4(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
