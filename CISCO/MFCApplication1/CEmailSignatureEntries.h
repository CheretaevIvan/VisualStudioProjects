...
// CEmailSignatureEntries класс-оболочка

class CEmailSignatureEntries : public COleDispatchDriver
{
public:
	CEmailSignatureEntries(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// EmailSignatureEntries свойства
public:
