...
// CTableOfAuthorities класс-оболочка

class CTableOfAuthorities : public COleDispatchDriver
{
public:
	CTableOfAuthorities(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
