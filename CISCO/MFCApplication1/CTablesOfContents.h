...
// CTablesOfContents класс-оболочка

class CTablesOfContents : public COleDispatchDriver
{
public:
	CTablesOfContents(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
