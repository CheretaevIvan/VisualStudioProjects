...
// CTablesOfAuthorities класс-оболочка

class CTablesOfAuthorities : public COleDispatchDriver
{
public:
	CTablesOfAuthorities(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
