...
// CHorizontalLineFormat класс-оболочка

class CHorizontalLineFormat : public COleDispatchDriver
{
public:
	CHorizontalLineFormat(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
