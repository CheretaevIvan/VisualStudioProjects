...
// CTwoInitialCapsExceptions класс-оболочка

class CTwoInitialCapsExceptions : public COleDispatchDriver
{
public:
	CTwoInitialCapsExceptions(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// TwoInitialCapsExceptions методы
public:
	...
	// TwoInitialCapsExceptions свойства
public:
