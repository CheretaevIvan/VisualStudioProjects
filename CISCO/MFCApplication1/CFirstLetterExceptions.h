...
// CFirstLetterExceptions класс-оболочка

class CFirstLetterExceptions : public COleDispatchDriver
{
public:
	CFirstLetterExceptions(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// FirstLetterExceptions свойства
public:
