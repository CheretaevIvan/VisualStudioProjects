...
// CBuildingBlockTypes класс-оболочка

class CBuildingBlockTypes : public COleDispatchDriver
{
public:
	CBuildingBlockTypes(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
