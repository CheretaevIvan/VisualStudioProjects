...
// CHangulAndAlphabetException класс-оболочка

class CHangulAndAlphabetException : public COleDispatchDriver
{
public:
	CHangulAndAlphabetException(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// HangulAndAlphabetException методы
public:
	...
	// HangulAndAlphabetException свойства
public:
