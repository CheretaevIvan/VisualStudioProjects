...
// CContentControlListEntries класс-оболочка

class CContentControlListEntries : public COleDispatchDriver
{
public:
	CContentControlListEntries(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// ContentControlListEntries методы
public:
	...
	// ContentControlListEntries свойства
public:
