...
// CCategoryCollection класс-оболочка

class CCategoryCollection : public COleDispatchDriver
{
public:
	CCategoryCollection(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
