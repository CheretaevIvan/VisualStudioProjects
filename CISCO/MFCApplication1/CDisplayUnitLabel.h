...
// CDisplayUnitLabel класс-оболочка

class CDisplayUnitLabel : public COleDispatchDriver
{
public:
	CDisplayUnitLabel(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
