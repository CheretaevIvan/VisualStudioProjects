...
// CHangulHanjaConversionDictionaries класс-оболочка

class CHangulHanjaConversionDictionaries : public COleDispatchDriver
{
public:
	CHangulHanjaConversionDictionaries(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// HangulHanjaConversionDictionaries методы
public:
	...
	// HangulHanjaConversionDictionaries свойства
public:
