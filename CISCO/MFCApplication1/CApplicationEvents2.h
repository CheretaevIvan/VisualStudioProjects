...
// CApplicationEvents2 класс-оболочка

class CApplicationEvents2 : public COleDispatchDriver
{
public:
	CApplicationEvents2(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
