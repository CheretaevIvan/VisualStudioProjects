...
// CSpellingSuggestions класс-оболочка

class CSpellingSuggestions : public COleDispatchDriver
{
public:
	CSpellingSuggestions(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
