...
// COptions класс-оболочка

class COptions : public COleDispatchDriver
{
public:
	COptions(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	BOOL get_CloudSignInOption()
	{
		BOOL result;
		InvokeHelper(0x204, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_CloudSignInOption(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x204, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
