...
// CMappedDataFields класс-оболочка

class CMappedDataFields : public COleDispatchDriver
{
public:
	CMappedDataFields(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
