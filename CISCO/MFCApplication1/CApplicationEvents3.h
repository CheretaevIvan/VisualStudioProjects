...
// CApplicationEvents3 класс-оболочка

class CApplicationEvents3 : public COleDispatchDriver
{
public:
	CApplicationEvents3(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
