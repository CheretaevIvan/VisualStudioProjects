...
// CProofreadingErrors класс-оболочка

class CProofreadingErrors : public COleDispatchDriver
{
public:
	CProofreadingErrors(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
