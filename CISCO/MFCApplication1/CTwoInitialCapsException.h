...
// CTwoInitialCapsException класс-оболочка

class CTwoInitialCapsException : public COleDispatchDriver
{
public:
	CTwoInitialCapsException(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// TwoInitialCapsException методы
public:
	...
	// TwoInitialCapsException свойства
public:
