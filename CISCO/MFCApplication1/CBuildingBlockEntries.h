...
// CBuildingBlockEntries класс-оболочка

class CBuildingBlockEntries : public COleDispatchDriver
{
public:
	CBuildingBlockEntries(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
