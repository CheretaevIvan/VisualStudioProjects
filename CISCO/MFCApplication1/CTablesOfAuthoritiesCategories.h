...
// CTablesOfAuthoritiesCategories класс-оболочка

class CTablesOfAuthoritiesCategories : public COleDispatchDriver
{
public:
	CTablesOfAuthoritiesCategories(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// TablesOfAuthoritiesCategories методы
public:
	...
	// TablesOfAuthoritiesCategories свойства
public:
