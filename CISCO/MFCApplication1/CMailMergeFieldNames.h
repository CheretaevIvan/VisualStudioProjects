...
// CMailMergeFieldNames класс-оболочка

class CMailMergeFieldNames : public COleDispatchDriver
{
public:
	CMailMergeFieldNames(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
