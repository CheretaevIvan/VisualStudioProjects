...
// CXMLSchemaReferences класс-оболочка

class CXMLSchemaReferences : public COleDispatchDriver
{
public:
	CXMLSchemaReferences(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
