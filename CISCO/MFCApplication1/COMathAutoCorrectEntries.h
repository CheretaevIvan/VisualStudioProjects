...
// COMathAutoCorrectEntries класс-оболочка

class COMathAutoCorrectEntries : public COleDispatchDriver
{
public:
	COMathAutoCorrectEntries(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// OMathAutoCorrectEntries методы
public:
	...
	// OMathAutoCorrectEntries свойства
public:
