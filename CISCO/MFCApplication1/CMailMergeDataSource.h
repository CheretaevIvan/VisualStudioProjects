...
// CMailMergeDataSource класс-оболочка

class CMailMergeDataSource : public COleDispatchDriver
{
public:
	CMailMergeDataSource(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
