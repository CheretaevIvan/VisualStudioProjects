...
// CTextEffectFormat класс-оболочка

class CTextEffectFormat : public COleDispatchDriver
{
public:
	CTextEffectFormat(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
