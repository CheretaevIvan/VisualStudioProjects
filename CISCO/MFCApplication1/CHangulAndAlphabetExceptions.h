...
// CHangulAndAlphabetExceptions класс-оболочка

class CHangulAndAlphabetExceptions : public COleDispatchDriver
{
public:
	CHangulAndAlphabetExceptions(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// HangulAndAlphabetExceptions методы
public:
	...
	// HangulAndAlphabetExceptions свойства
public:
