...
// CSeriesCollection класс-оболочка

class CSeriesCollection : public COleDispatchDriver
{
public:
	CSeriesCollection(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
