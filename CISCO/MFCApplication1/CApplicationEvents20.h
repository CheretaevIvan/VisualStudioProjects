...
// CApplicationEvents20 класс-оболочка

class CApplicationEvents20 : public COleDispatchDriver
{
public:
	CApplicationEvents20(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
