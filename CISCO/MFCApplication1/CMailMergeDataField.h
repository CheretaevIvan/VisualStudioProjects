...
// CMailMergeDataField класс-оболочка

class CMailMergeDataField : public COleDispatchDriver
{
public:
	CMailMergeDataField(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
