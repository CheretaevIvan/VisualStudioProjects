...
// COMathAutoCorrectEntry класс-оболочка

class COMathAutoCorrectEntry : public COleDispatchDriver
{
public:
	COMathAutoCorrectEntry(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// OMathAutoCorrectEntry свойства
public:
