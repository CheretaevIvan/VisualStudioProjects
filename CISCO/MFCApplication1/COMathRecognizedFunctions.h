...
// COMathRecognizedFunctions класс-оболочка

class COMathRecognizedFunctions : public COleDispatchDriver
{
public:
	COMathRecognizedFunctions(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
...
public:
	...
	// OMathRecognizedFunctions методы
public:
	...
	// OMathRecognizedFunctions свойства
public:
