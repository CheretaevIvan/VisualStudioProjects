...
// CParagraphFormat класс-оболочка

class CParagraphFormat : public COleDispatchDriver
{
public:
	CParagraphFormat(){} // ¬ызывает конструктор по умолчанию дл€ COleDispatchDriver
